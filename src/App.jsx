...
const App = () =>{
  const flashCards = [{id:1, word:'熊猫', translation:'panda', color: '#a7eaaed9', img:'https://www.creativefabrica.com/wp-content/uploads/2023/05/19/Cute-Adorable-Baby-Panda-70054573-1.png'}, 
  ...
  {id:6, word:'踢足球', translation:'play coccer', color:'#e6e26fd9', img:'https://creazilla-store.fra1.digitaloceanspaces.com/cliparts/38244/schoolboys-soccer-football-clipart-xl.png'},
  ...
  return(
    <div className='App'>
      ...
      <h4>Number of card: {flashCards.length}</h4>
